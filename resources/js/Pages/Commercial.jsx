                        ...
                        <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-2 lg:gap-14">
                            <div>
                                ...
                                <h2 className="mt-4 font-display text-[34px] uppercase leading-[0.95] text-[#07264A] md:text-[46px] lg:text-[54px]">
                                    Keep Your <span className="text-brand-orange">Business</span> Running
                                </h2>
                                <div className="mt-6 space-y-5 font-body text-[15px] leading-relaxed text-gray-600 md:text-base">
                                    <p>
                                        When your commercial HVAC system fails on a 95-degree day or a burst pipe floods your retail space, every minute of downtime costs money. We understand that business owners need fast, reliable service that minimizes disruption and gets operations back to normal.
                                    </p>
                                    <p>
                                        Our commercial team handles rooftop units, boilers, chillers, commercial plumbing, and electrical work for offices, restaurants, retail spaces, and multi-family buildings. We offer preventative maintenance programs to catch problems before they become emergencies — and 24/7 response when they do.
                                    </p>
                                </div>
                            ...
                            <div className="relative">
                                <img
                                    ...
                                    alt="Guardian Air commercial technician servicing a rooftop HVAC unit in New Jersey"
                                ...
                                <div className="absolute -bottom-4 -left-3 hidden rounded-xl bg-white p-4 shadow-lg ring-1 ring-gray-100 lg:block">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-sm font-extrabold text-[#07264A]">Commercial Accounts</p>
                                            <p className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Custom Maintenance Plans</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
